...
* [#137](https://github.com/slack-ruby/slack-ruby-bot/pull/137): Add Model-View-Controller classes to allow for more explicit control over how `command`s are designed. Helpful for complex commands with lots of business logic, plus improves ability to spec/test. - [@chuckremes](https://github.com/chuckremes).
