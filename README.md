...
You're reading the documentation for the **next** release of slack-ruby-bot. Please see the documentation for the [last stable release, v0.5.2](https://github.com/dblock/slack-ruby-bot/tree/v0.5.2) unless you're integrating with HEAD.
